...
Trong cùng thư mục có file `HUONG_DAN_CAI_DAT.md`, viết từ trước và nhiều chỗ đã cũ (thông số bàn
...
| `position_cards.pdf` | A4 dọc | **100% / actual size** | đo vạch 50 mm in sẵn, rồi cắt 20 thẻ theo viền |
